            ...
            <form action="/productStore" method="post" enctype="multipart/form-data">
                ...
                {{-- stok --}}
                    ...
                    <div class="relative flex items-center max-w-[8rem]">
                        ...
                        <input type="text" id="quantity-input" name="stock" data-input-counter aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="999" required>
                ...
                <div class="relative w-full">
                    ...
                    <input type="number" name="price" class="block p-2.5 w-full z-20 ps-10 text-sm text-gray-900 bg-gray-50 rounded-lg border-e-gray-50 border-e-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none" placeholder="Masukan harga" required>
                </div>
                <br>
                {{-- kategori --}}
                <div class="mb-6">
                ...
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    ...
                    <input id="dropzone-file" name="image" type="file" class="hidden" accept=".png, .jpg"/>
                </label>
                </div>
                <br>
